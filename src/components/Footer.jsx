...
export default function Footer() {
  ...
  return (
    <footer style={{ background: 'var(--surface-low)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '12px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
